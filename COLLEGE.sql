...
ALTER TABLE STUDENT_DETAILS ADD COLUMN CITY VARCHAR(30);

UPDATE STUDENT_DETAILS SET CITY="TIRUPATI" WHERE ID=101;
UPDATE STUDENT_DETAILS SET CITY="CHITTOOR" WHERE ID=102;
